            ...
            ->schema([
                        ...
                        FileUpload::make('file')
                            ...
                            ->getUploadedFileNameForStorageUsing(
                                fn (TemporaryUploadedFile $file): string => (string) str($file->getClientOriginalName())
                                    ->prepend(now()->format('Y-m-d').'-recurso-prova-'.str_replace(' ', '_', auth()->user()->name).'-'.now()->format('h-i-s').'-')
                            ),
                ...
                Section::make('Deliberar recurso (coordenação)')
                    ...
                    ->schema([
                        ...
                        TextInput::make('sei_number')
                            ->label('Número do Processo SEI')
                            ->numeric()
                            ->columnSpan(2)
                            ->placeholder('202500010000'),
